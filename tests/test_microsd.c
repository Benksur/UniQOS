/**
 * @file test_microsd.c
 * @brief MicroSD card test program
 * @ingroup tests
 *
 * Test program for microSD card functionality including FAT filesystem
 * operations, file reading/writing, and storage space monitoring.
 */
