...
int main(void)
{
    ...
    uint8_t data = 0;
    status = HAL_I2C_Mem_Read(&AUDIO_I2C_HANDLE, NAU88C22_I2C_ADDR, NAU_REVISION, I2C_MEMADD_SIZE_8BIT, &data, 1, 1000);
    printf("%d", status);

    
    status = HAL_I2C_Mem_Write(&AUDIO_I2C_HANDLE, NAU88C22_I2C_ADDR << 1, NAU_RESET, I2C_MEMADD_SIZE_8BIT, &data, 1, 1000);

    printf("%d", status);

    status = HAL_I2C_Mem_Write(&AUDIO_I2C_HANDLE, NAU88C22_I2C_ADDR, NAU_RESET, I2C_MEMADD_SIZE_8BIT, &data, 1, 1000);
