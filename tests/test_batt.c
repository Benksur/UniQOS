...
/**
 * @file test_batt.c
 * @brief Battery management test program
 * @ingroup tests
 *
 * Test program for battery fuel gauge (BQ27441) and charging controller (MCP73871).
 * Displays battery voltage, current, state of charge, and charging status.
 */
