...
{
    if (state->error || state->operation == OP_NONE)
        return;
...
static void handle_operator(CalculatorState *state, char op)
{
    ...
    {
    case '+':
        set_operation(state, OP_ADD);
        break;
    case '-':
        set_operation(state, OP_SUB);
        break;
    case '*':
        set_operation(state, OP_MUL);
        break;
    case '/':
        set_operation(state, OP_DIV);
        break;
    case '=':
...
static void calculator_handle_input(Page *self, int event_type)
{
    ...
    case INPUT_KEYPAD_1:
        ...
        break;
    case INPUT_KEYPAD_2:
        handle_keypad_input(self, event_type, '2');
        break;
    case INPUT_KEYPAD_3:
        handle_keypad_input(self, event_type, '3');
        break;
    case INPUT_KEYPAD_4:
        handle_keypad_input(self, event_type, '4');
        break;
    case INPUT_KEYPAD_5:
        handle_keypad_input(self, event_type, '5');
        break;
    case INPUT_KEYPAD_6:
        handle_keypad_input(self, event_type, '6');
        break;
    case INPUT_KEYPAD_7:
        handle_keypad_input(self, event_type, '7');
        break;
    case INPUT_KEYPAD_8:
        handle_keypad_input(self, event_type, '8');
        break;
    case INPUT_KEYPAD_9:
        handle_keypad_input(self, event_type, '9');
        break;
    case INPUT_KEYPAD_STAR:
        add_decimal(state);
        break; // * key for decimal
...
Page *calculator_page_create()
{
    ...
    CalculatorState *state = mem_malloc(sizeof(CalculatorState));
