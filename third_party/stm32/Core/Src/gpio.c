...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PB_HASH_Pin PB_VOL_DOWN_Pin PB_VOL_UP_Pin PB_DPAD_LEFT_Pin
                           PB_DPAD_SELECT_Pin PB_STAR_Pin PB_0_Pin */
  GPIO_InitStruct.Pin = PB_HASH_Pin|PB_VOL_DOWN_Pin|PB_VOL_UP_Pin|PB_DPAD_LEFT_Pin
                          |PB_DPAD_SELECT_Pin|PB_STAR_Pin|PB_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : PB_1_Pin PB_2_Pin PB_3_Pin PB_MENU_L_Pin
                           PB_MENU_R_Pin PB_4_Pin PB_5_Pin */
  GPIO_InitStruct.Pin = PB_1_Pin|PB_2_Pin|PB_3_Pin|PB_MENU_L_Pin
                          |PB_MENU_R_Pin|PB_4_Pin|PB_5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pins : PB_6_Pin PB_7_Pin PB_PWR_Pin PB_HANG_Pin */
  GPIO_InitStruct.Pin = PB_6_Pin|PB_7_Pin|PB_PWR_Pin|PB_HANG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pins : PB_DPAD_UP_Pin PB_DPAD_DOWN_Pin PB_DPAD_RIGHT_Pin */
  GPIO_InitStruct.Pin = PB_DPAD_UP_Pin|PB_DPAD_DOWN_Pin|PB_DPAD_RIGHT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
