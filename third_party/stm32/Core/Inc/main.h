...
#define PB_4_Pin GPIO_PIN_2
#define PB_4_GPIO_Port GPIOC
#define PB_5_Pin GPIO_PIN_3
#define PB_5_GPIO_Port GPIOC
#define PB_6_Pin GPIO_PIN_0
#define PB_6_GPIO_Port GPIOA
#define PB_7_Pin GPIO_PIN_1
#define PB_7_GPIO_Port GPIOA
#define PB_PWR_Pin GPIO_PIN_2
...
#define PB_VOL_DOWN_Pin GPIO_PIN_7
#define PB_VOL_DOWN_GPIO_Port GPIOE
#define PB_VOL_UP_Pin GPIO_PIN_8
#define PB_VOL_UP_GPIO_Port GPIOE
#define PB_DPAD_LEFT_Pin GPIO_PIN_9
#define PB_DPAD_LEFT_GPIO_Port GPIOE
#define PB_DPAD_SELECT_Pin GPIO_PIN_10
#define PB_DPAD_SELECT_GPIO_Port GPIOE
