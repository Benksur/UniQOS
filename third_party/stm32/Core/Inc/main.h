...
#define PB_6_Pin GPIO_PIN_8
#define PB_6_GPIO_Port GPIOD
#define PB_7_Pin GPIO_PIN_11
#define PB_7_GPIO_Port GPIOD
...
#define PB_VOL_UP_Pin GPIO_PIN_14
#define PB_VOL_UP_GPIO_Port GPIOD
...
#define PB_VOL_DOWN_Pin GPIO_PIN_0
#define PB_VOL_DOWN_GPIO_Port GPIOD
#define PB_STAR_Pin GPIO_PIN_1
#define PB_STAR_GPIO_Port GPIOD
#define PB_0_Pin GPIO_PIN_5
#define PB_0_GPIO_Port GPIOD
#define PB_CALL_Pin GPIO_PIN_6
#define PB_CALL_GPIO_Port GPIOD
#define PB_9_Pin GPIO_PIN_7
#define PB_9_GPIO_Port GPIOD
